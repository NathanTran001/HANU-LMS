...
export const EDIT_COURSE_PAGE = "/courses/edit/:code";
export const COURSE_DETAIL_PAGE = "/courses/:code";
export const SEARCH_COURSE_PAGE = "/courses/search/:searchPhrase";
